<div class="container mx-auto px-4 py-8">
    ...
    <div x-show="$wire.isModalOpen" x-on:keydown.escape.window="$wire.closeModal()" x-trap.inert.noscroll="$wire.isModalOpen" class="fixed inset-0 z-50 flex items-center justify-center p-4" x-cloak>
        ...
        <div class="card relative w-full max-w-lg bg-white p-8" x-show="$wire.isModalOpen"
            ...
            <h3 class="text-2xl font-bold text-[--color-dark] mb-6">{{ $jabatan_id ? 'Edit' : 'Tambah' }} Data Jabatan</h3>
            <form wire:submit.prevent="store" class="space-y-6">
                <div>
                    <label for="jabatan" class="block text-sm font-medium text-[--color-dark] mb-1">Nama Jabatan</label>
                    <input type="text" id="jabatan" wire:model="jabatan" x-ref="focusInput" class="w-full rounded-lg border-gray-300 shadow-sm focus:ring-[--color-accent] focus:border-[--color-accent]">
